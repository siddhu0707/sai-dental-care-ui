  ...
  private translations: Record<SupportedLanguage, TranslationData> = {
    en: {
      ...
      clinic: {
        ...
        address: 'Chattrapati Shivaji Maharaj Chowk, Nere-Dattawadi, Mulashi, Pune - 411057',
        phone: '+91 98765 43210',
        email: 'info@saidentalcare.com',
        doctor: 'Dr. Snahe Funde BDS (MUHS)',
        regNo: 'A-50911',
        tagline: 'Smile, it lets your teeth breathe',
        regNoLabel: 'Reg. No'
      },
      dashboard: {
        title: 'Dashboard',
      ...
      appointments: {
        ...
        noReminder: 'No reminder sent',
        sendReminder: 'Send Reminder',
        sendReminders: 'Send Reminders',
        todayReminders: 'Today\'s Appointment Reminders',
        todayTomorrowReminders: 'Today & Tomorrow Appointment Reminders',
        selectedAppointments: 'Selected Appointments',
        customMessage: 'Custom Message',
        messagePlaceholder: 'Enter your reminder message for patients...',
        ...
        sendTime: 'Send Time',
        sendNow: 'Send Now',
        send1HourBefore: '1 Hour Before',
        send2HoursBefore: '2 Hours Before',
        send1DayBefore: '1 Day Before',
    ...
    mr: {
      common: {
        ...
        noAppointments: 'आजसाठी कोणत्याही भे��ी नियोजित नाहीत',
      ...
      clinic: {
        ...
        address: '१२३ मुख्य रस्ता, श���र, राज्य १२३४५',
        phone: 'फोन: (५५५) १२३-४���६���'
      },
      dashboard: {
        title: 'डॅशबोर्ड',
        ...
        allPaid: '���र्व रुग्णांनी त्यांची बिले भरली आहेत!',
        alerts: 'इशारे आणि सूचना'
      },
      patients: {
        title: 'रुग्ण व्यवस्थापन',
        subtitle: 'रुग्णांचे रेकॉर्ड आणि माहिती व्यवस��थापित करा',
        ...
        searchPlaceholder: 'नाव, ईमेल कि���वा फोन नंबरवरून रुग��ण शोधा...',
        noPatients: 'कोणतेही रुग्ण सापडले नाहीत',
        patientDetails: 'रुग्णाचे तपशील',
        visitInfo: 'भेटीच�� माहिती',
        ...
        adjustSearch: 'आ��ले शोध निकष समायोजित करण्याचा प्रयत्न करा',
        addFirstPatient: 'आपला पहिला रुग्ण जोडून सुरुवात करा',
        editPatient: 'रुग्ण संप���दित करा',
        ...
        medicalInfo: 'वैद्यकीय माहित��',
        commaSeparated: 'स्वल्पविरामने विभ���्त',
      ...
      appointments: {
        ...
        noReminder: 'स्मरणपत्र पाठवले नाही',
        sendReminder: 'स्मर��पत्र पाठवा',
        sendReminders: 'स्मरणपत्रे पाठवा',
        todayReminders: 'आजच्या भेटींसाठी स्मरणपत्रे',
        todayTomorrowReminders: 'आज आणि उद्याच्या भेटींसाठी स्मरणपत्रे',
        selectedAppointments: 'निवडलेल्या भेटी',
        customMessage: 'कस्टम संदेश',
        messagePlaceholder: 'रुग्णांसाठी आपला ��्मरणपत्र ��ंदेश लि��ा...',
        reminderMethod: 'स्म���णपत्र पद्धत',
        sms: 'SMS',
        email: 'ईमेल',
        both: 'SMS आणि ईमेल दोन्ही',
        sendTime: 'पाठवण्याची वेळ',
        sendNow: 'आत्ता पाठवा',
        send1HourBefore: '1 तास आधी',
        send2HoursBefore: '2 तास आधी',
        send1DayBefore: '1 दिवस आधी',
      ...
      billing: {
        ...
        recordPayment: 'पेमेंट नों���वा',
        markPaid: 'भरले म्��णून चिन्हांकित करा',
        sendBill: 'बिल पाठवा',
        pendingBills: 'प��रलंबित बिले'
      },
      validation: {
